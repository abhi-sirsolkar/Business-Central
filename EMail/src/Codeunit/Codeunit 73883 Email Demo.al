codeunit 73883 Email_Practice
{
    ...
    begin
        EmailMessage.Create('abhishek.sirsolkar@intech-systems.com', 'This is the subject', 'This is the body');
    ...
    begin
        ...
        EmailMessage.Create('abhishek.sirsolkar@intech-systems.com', 'Sample Report', Body, true);
    ...
    begin
        ...
        EmailMessage.Create('abhishek.sirsolkar@intech-systems.com', 'This is the subject', Body, true);
    ...
    begin
        ...
        EmailMessage.Create('arpan.shukla@intech-systems.com', 'This is the subject', Body, true);
    ...
    begin
        ...
        ListTo.Add('abhishek.sirsolkar@intech-systems.com');
        ListTo.Add('arpan.shukla@intech-systems.com');
        ListTo.Add('manish.tank@intech-systems.com');
